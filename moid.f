c ==================================================================================================================================
c Nov 15, 2024: All I've done is modify this code to be a subroutine which can then be compiled and called from python. -HFA 
c
c
...
c ==================================================================================================================================
      subroutine moid_func (saxisA, eccenA, incliA, argpeA, omegaA,
     a saxisB, eccenB,  incliB, argpeB, omegaB, moid)
      implicit real*8 (a-h,o-z), integer*4 (i-n)
      real*8, intent(inout) :: saxisA,eccenA,incliA,argpeA,omegaA, 
     a saxisB,eccenB,incliB,argpeB,omegaB
      real*8, intent(out) :: moid

      real*8 longit,longit_m,longit_o
...
!     orignally, these were hardcoded...
